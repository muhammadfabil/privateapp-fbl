/**
 * ISSI (Indonesia Sharia Stock Index) Constituent List
 * Source: IDX (Indonesia Stock Exchange) - issi_idx.xlsx
 *
 * Total: 630 stocks
 * Update this list periodically (May & November) when OJK releases new DES.
 */
export const issiStocks = [
    ...
    'WIRG', 'WMUU', 'WOOD', 'WOWS', 'WTON', 'YELO', 'YPAS', 'YUPI', 'ZATA', 'ZONE', 'ZYRX',
];
export function getIssiSymbols() {
    return issiStocks;
}
export function getIssiStockBySymbol(symbol) {
    return issiStocks.find(stock => stock === symbol);
}
//# sourceMappingURL=issiStocks.js.map