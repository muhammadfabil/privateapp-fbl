import { getNewPage, delay } from './browser.js';
import { parseAllData, parseStockPage } from '../parser/googleFinance.js';
import { config } from '../config.js';
import { db } from '../db/index.js';
import { stocks, priceHistory, incomeStatements, balanceSheets, cashFlows, stockNews } from '../db/schema.js';
 ...
 */
export async function scrapeStockFull(symbol, page) {
 ...
 */
export async function scrapeStock(symbol, page) {
 ...
 */
export async function scrapeStocksFull(symbols) {
    const results = [];
    let success = 0;
    let failed = 0;
 ...
 */
export async function scrapeStocks(symbols) {
    const results = [];
    let success = 0;
    let failed = 0;
    const page = await getNewPage();
 ...
 */
export async function scrapeStocksInBatches(symbols, fullData = true) {
 ...
 */
async function saveCompleteStockData(symbol, data) {
    // Save overview
 ...
 */
async function saveStockData(symbol, data) {
 ...
 */
async function savePriceHistory(symbol, history) {
 ...
 */
async function saveIncomeStatements(symbol, statements) {
 ...
 */
async function saveBalanceSheets(symbol, sheets) {
 ...
 */
async function saveCashFlows(symbol, flows) {
 ...
 */
async function saveStockNews(symbol, news) {
...
//# sourceMappingURL=stockScraper.js.map